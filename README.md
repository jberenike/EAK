...
It is an interesting question how vividness/imagery may be modeled in terms of metaphorical and non-metaphorical types of concreteness. Nonmetaphorical types of imagery (with many references to concrete objects and bodily actions) appear to contrast with the type exhibited by texts high on metaphor, among which are modernistic descriptions of emotions and industrial towns scenery. Here, it is subjective worldviews and perception that are rendered vividly through metaphorical reference to concrete objects and bodily actions.
